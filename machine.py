...
from isa import SignalsALU, SignalsLeftALU, SignalsRightALU, SignalsPC, AddrType
from isa import opcode_to_alu_opcode
    ...
    def signal_left_fetch(self, sel: SignalsLeftALU):
        match sel:
            case SignalsLeftALU.INPUT:
                self.alu_left_gate = ord(self.input_buffer.pop(0)) if self.input_buffer[0] != "0" else 0
